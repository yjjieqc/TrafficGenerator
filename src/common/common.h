...
// to cooperate with log_throughput_function
struct stru_throughput
{
    unsigned int interval_us;
    FILE *log_fd;
    unsigned int byte_total_read;
    bool end_child_thread;
...
//extend the read_exact function to create a thread to output throughput to log
...
//a log throughput function to cooperate with ex_read_exact
void *log_throughput(void *ptr);

// a function to react to a signal SIGTERM
...
/* set dscp according to flowsize */
